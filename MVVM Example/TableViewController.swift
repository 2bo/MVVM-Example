...
class TableViewController: UITableViewController {
    ...
    /**
     Download Image from photoURL and Set it on cell
     
     - parameter cell: Target cell in TableView
     - parameter photoURL: Download url
